          ...
          >
            <div className="relative inline-block mb-6">
              <span className={`inline-flex items-center px-3 py-1 text-xs font-medium tracking-wider uppercase bg-gradient-to-r ${badgeGradient ? BADGE_GRADIENTS[badgeGradient as keyof typeof BADGE_GRADIENTS] || 'from-pink-500 to-purple-500' : 'from-pink-500 to-purple-500'} text-transparent bg-clip-text relative`}>
                ...
                {faqSection.badge || "PERGUNTAS FREQUENTES"}
              </span>
            </div>
            <h2 className="font-display font-semibold text-3xl sm:text-4xl lg:text-5xl text-gray-900 mb-4 tracking-tight">
              {processTextWithGradient(faqSection.title || "Respondemos suas (principais dúvidas)", badgeGradient)}
            </h2>
            <p className="text-gray-600 text-lg max-w-2xl mx-auto leading-relaxed">
              {faqSection.subtitle || "Encontre respostas para as principais questões sobre o atendimento"}
            </p>
